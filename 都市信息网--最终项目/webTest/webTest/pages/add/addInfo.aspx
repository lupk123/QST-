<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="addInfo.aspx.cs" Inherits="webTest.pages.add.addInfo" %>
						...
						<td background="../../images/default_m.jpg" valign="top" align="center">
							...
							<table border="0" width="650" height="300" rules="all" cellspacing="0">
									...
									<td align="center">
										<table border="0" width="650" rules="all" cellspacing="8">                    
											...
											<tr>
												...
												<td colspan="2">
                                                    <asp:TextBox ID="phone" runat="server" Width="164px"></asp:TextBox>
											...
											<tr>
												...
												<td colspan="2">
                                                    <asp:TextBox ID="linkman" runat="server" Width="168px"></asp:TextBox>
                                                </td>
											</tr>
											<tr><td colspan="3"></td></tr>
											<tr>
								...
								<tr align="center" height="50">
									<td>
										&nbsp;<asp:Button ID="Ok" runat="server" onclick="Ok_Click" Text="发布" />
